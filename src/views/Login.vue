...
export default class Login extends Vue {
    ...
    oAuth: string = 'https://tagnet.auth0.com/login?client=2rUl0BvJ91rrfBI7t0tXcFC6yxx0HF3K&protocol=oauth2&response_type=token id_token&redirect_uri=http://localhost:8080/callback&scope=openid profile' 
    @Getter('user/status') logginInStatus
